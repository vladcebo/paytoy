...
use crate::{client_account::ClientAccount, records::ClientId, transactions_reader::TransactionsStream};
...
impl AccountManager {
    ...
    // pub fn get_client_account(&self, client_id: ClientId) -> Option<&ClientAccount> {
    //     self.accounts.
    // }
}
...
mod tests {
    ...
    */
    ...
    fn test_basic_transactions() {
        let transactions = transactions_reader::STBulkReader::new().read_csv("/tests/data/test_basic.csv").unwrap();
